...
#define MyAppId "{{72B7C44E-B05E-5594-B166-D761443E7AA9}"
#define MyAppName "SCM Charts"
#define MyAppExeName "SCM_Charts.exe"
#define MyInnoOutputDir "C:\Users\Ben\Documents\GitHub\SCM_Charts\DEPLOY\INNO\OUTPUT\"
#define MyAppIconFileName "SCM_Charts.ico"
...
; ----------------------------------------------------------------------
;   64BIT 64BIT 64BIT 64BIT 64BIT 64BIT 64BIT 64BIT 64BIT 64BIT 64BIT 64BIT 
; ----------------------------------------------------------------------
#define MyReleaseBuildDir "C:\Users\Ben\Documents\GitHub\SCM_Charts\Win64\Release\"

; DEPLOY (INNO project folder, ChangeLog.txt, License.rtf,  ReadMe.txt, QuickStartReadMe.txt)
#define MyDeployDir "C:\Users\Ben\Documents\GitHub\SCM_Charts\DEPLOY\"

; ASSETS (icons, image, wav, powershell scripts for ImageMagick)
#define MyAssetDir "C:\Users\Ben\Documents\GitHub\SCM_Charts\ASSETS\"

; Adobe ROBOHELP for Charts COMPILED WinHelp files - OUTPUT DIR
...
DefaultDirName={autopf}\{#MyAppPublisher}\Charts
DefaultGroupName={#MyAppPublisher}\Charts
...
OutputBaseFilename={#MyAppName}_64bit_v{#MyAppVersionL}
...
VersionInfoDescription=SwimClubMeet (SCM) Charts 
...
UninstallDisplayName=SwimClubMeet (SCM) Charts
...
; H E L P   F I L E S
; ----------------------------------------------------------------------
; Charts Web based help files GENERATED (compiled) by Adobe RoboHelp
...
[Icons]
Name: "{group}\Charts"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}\"; Components: SCMcore
;Name: "{group}\Charts Help"; Filename: "{commonappdata}{#MySubPath}SCM_Help\index.htm"; WorkingDir: "{app}\"; IconFilename: "{app}\SCM_Help.ico"; Components: SCMhelp
Name: "{commondesktop}\SCM Charts"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}\"; Tasks: desktopicon; Components: SCMcore
;Name: "{commondesktop}\Help for Charts"; Filename: "{commonappdata}{#MySubPath}SCM_Help\index.htm"; WorkingDir: "{app}\"; Tasks: desktopicon; IconFilename: "{app}\SCM_Help.ico"; Components: SCMhelp
Name: "{group}\Uninstall Charts"; Filename: "{uninstallexe}"; IconFilename: "{app}\{#MyAppExeName}"
...
[Components]
Name: "SCMcore"; Description: "SwimClubMeet (SCM) Charts"; Types: full; Flags: fixed
;Name: "SCMhelp"; Description: "Help for Charts"; Types: full

[Types]
Name: "full"; Description: "Core application and help files."; Flags: iscustom

[UninstallDelete]
Type: files; Name: "{userappdata}\Artanemus\SCM\SCM_ChartsPref.ini"
