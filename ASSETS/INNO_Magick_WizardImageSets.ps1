Set-Location C:\Users\Ben\Documents\GitHub\SCM_Charts\DEPLOY\INNO\
...
$leftpanel = $inpath + 'INNO-LeftPanel_SCM_Charts.png'
$square = $inpath + 'SCM_Charts-800x800.png'

$outpath = 'C:\Users\Ben\Documents\GitHub\SCM_Charts\DEPLOY\INNO\'
